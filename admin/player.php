            ...
            <div class="col-md-9 grid-margin transparent">
              <div class="demo-tabs">
                ...
                <div data-pws-tab="pod" data-pws-tab-name="POD" class="playerpod">
                  ...
                  <?php else: ?>
                    <li class="list-group-item text-muted text-center w-100">No POD yet.</li>
                  <?php endif; ?>
                        ...
                        <!-- <div class="card-body"> -->
                          ...
                          <div id="video-gallery" class="row lightGallery text-center">
                            ...
                            <?php if (count($videos) > 0): ?>
                              ...
                              <?php endforeach; ?>
                            <?php else: ?>
                              <li class="list-group-item text-muted text-center w-100">No videos uploaded yet.</li>
                            <?php endif; ?>
        ...
        <div class="modal-content">
            ...
            <input type="hidden" name="id" value="<?php echo $user_player['id']; ?>">
          	...
          	<div class="modal-footer justify-content-between">
            	...
            	<button type="submit" class="btn btn-danger btn-rounded btn-icon-text mb-4 mt-4" name="delete"><i class="mdi mdi-delete"></i>Delete</button>
          	</div>
          	</form>
        </div>
    </div>
