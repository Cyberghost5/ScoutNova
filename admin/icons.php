            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">API Documentation</h3>
                  <h6 class="font-weight-normal mb-0">How we offer this services.</h6>
                </div>
              </div>
            </div>
            <div class="col-md-12">
                ...
                if(isset($_SESSION['cancelled'])){
                  echo "
                    <div class='alert alert-secondary alert-dismissible'>
                      <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                      <h4><i class='icon mdi mdi-delete-forever'></i> Haba! Why? ðŸ˜‚ðŸ˜’!</h4>
                      ".$_SESSION['cancelled']."
                    </div>
                  ";
