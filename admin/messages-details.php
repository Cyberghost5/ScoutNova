            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Messages with <?php echo $row['user1_firstname'] . ' ' . $row['user1_lastname']; ?> & <?php echo $row['user2_firstname'] . ' ' . $row['user2_lastname']; ?></h6>
                </div>
              </div>
            </div>
            <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-12 bg-white p-3 rounded">
                      ...
                      <div class="card direct-chat direct-chat-primary">
                        <div class="card-body">   
                          <p>Chat with <?php echo $row['user1_firstname'] . ' ' . $row['user1_lastname']; ?> & <?php echo $row['user2_firstname'] . ' ' . $row['user2_lastname']; ?></p>
...
function loadMessages() {
  $.get('fetch_messages', { chat_id: <?= (int)$chat_id ?> }, function(data) {
    ...
    messages.forEach(msg => {
      ...
      let isRight = msg.user_id == <?php echo $admin['id']; ?>;
      ...
      console.log(role); // Debugging line
      html += `
        <div class="direct-chat-msg ${isRight ? 'right' : ''} ${isAdmin ? 'admin-message' : ''}">
          ...
          <img class="direct-chat-img" src="images/${msg.photo ? msg.photo : 'profile.jpg'}" alt="message user image">
