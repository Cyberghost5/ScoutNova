...
<html lang="en">
  <head>
    ...
    <title>Scout Nova | Discover Tomorrow's Football & Basketball Stars Today</title>

    <meta name="description" content="ScoutNova is a cutting-edge digital scouting platform connecting emerging football and basketball talents from Africa, South America, and beyond with professional scouts and agents across the globe.">
    <meta name="keywords" content="ScoutNova, digital scouting platform, football, basketball, talents, Africa, South America, professional scouts, agents">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="Content-Type" content="text/html;charset=UTF-8">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    
    <meta name="theme-color" content="#32f2ff">
    <meta name="msapplication-navbutton-color" content="#32f2ff">
    <meta name="apple-mobile-web-app-status-bar-style" content="#32f2ff">
    
    <meta property="og:title" content="Scout Nova"/>
    <meta property="og:locale" content="en_US"/>
    <meta property="og:url" content="http://localhost/nova/"/>
    <meta property="og:type" content="website"/>
    <meta property="og:description" content="Scout Nova">
    <meta property="og:image" content="assets/images/favicon.png">

    <meta property="twitter:card" content="summary"/>
    <meta property="twitter:title" content="Scout Nova"/>
    <meta property="twitter:description" content="Scout Nova">
    <meta property="twitter:url" content="http://localhost/nova/"/>
  ...
  <body>
    ...
    <div class="site-wrap">
      ...
      <!-- ======= Header =======-->
      <header class="fbs__net-navbar navbar navbar-expand-lg dark" aria-label="Scout Nova navbar">
        <div class="container d-flex align-items-center justify-content-between">
          ...
          <a class="navbar-brand w-auto" href="./">
            ...
            <!-- logo dark--><img class="logo dark img-fluid" src="assets/images/logo/logo.png" style="height: 50px" alt="Scout Nova image placeholder"> 
            
            <!-- logo light--><img class="logo light img-fluid" src="assets/images/logo-light.svg" alt="Scout Nova image placeholder">
            ...
            <div class="offcanvas-header">
              <div class="offcanvas-header-logo">
                ...
                <a class="logo-link" id="fbs__net-navbarsLabel" href="index.html">
                  ...
                  <!-- logo dark--><img class="logo dark img-fluid" src="assets/images/logo/logo.png" alt="Scout Nova image placeholder"> 
                  
                  <!-- logo light--><img class="logo light img-fluid" src="assets/images/logo-light.svg" alt="Scout Nova image placeholder"></a>
          ...
          <div class="ms-auto w-auto">
            ...
            <div class="header-social d-flex align-items-center gap-1">
              <a class="btn btn-primary py-2" href="register">Get Started</a>
      ...
      <main>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="row">
                  <div class="col-lg-11"><span class="hero-subtitle text-uppercase" data-aos="fade-up" data-aos-delay="0">Powered by AI | Transparent. Fair. Global.</span>
                    <h1 class="hero-title mb-3" data-aos="fade-up" data-aos-delay="100">Discover Tomorrow's Football & Basketball Stars Today</h1>
                    <p class="hero-description" data-aos="fade-up" data-aos-delay="200">ScoutNova is a cutting-edge digital scouting platform connecting emerging football and basketball talents from Africa, South America, and beyond with professional scouts and agents across the globe.</p>
                    <p class="hero-description mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="200">Powered by AI-driven video evaluation, swipe-based discovery, and real-time Player Overtime Development (POD) tracking — ScoutNova ensures that raw talent gets the global attention it deserves.</p>
              ...
              <div class="col-lg-6">
                <div class="hero-img">
                    <img class="img-card img-fluid" src="assets/images/agfc_1722254485.jpg" alt="Image card" data-aos="fade-down" data-aos-delay="600">
                    <img class="img-main img-fluid rounded-4" src="assets/images/ai-generated-8720124_1280.png" alt="Hero Image" data-aos="fade-in" data-aos-delay="500">
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="about__v4 section" id="about">
          <div class="container">
            <div class="row">
              <div class="col-md-6 order-md-2">
                <div class="row justify-content-end">
                  <div class="col-md-11 mb-4 mb-md-0"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">About us</span>
                    <h2 class="mb-4" data-aos="fade-up" data-aos-delay="100">Experience the future of scouting with our secure, efficient, and user-friendly platform</h2>
                    <div data-aos="fade-up" data-aos-delay="200">
                      <p>ScoutNova SportsTech Ltd is headquartered in Abuja, Nigeria, pioneering digital sports scouting solutions for emerging talent markets in Africa, South America, and beyond.</p>
                      <p>Our platform combines AI, data analytics, and user-friendly interfaces to transform how players are discovered and developed.</p>

                      <p>Founded by a team of sports enthusiasts and tech innovators, ScoutNova is committed to democratizing access to professional opportunities for young athletes worldwide.</p>

                      <p>We believe in transparency, fairness, and the power of technology to bridge gaps in the sports industry. By leveraging AI-driven video analysis and real-time performance tracking, we provide scouts and agents with unparalleled insights into player potential.</p>
              ...
              <div class="col-md-6"> 
                <div class="img-wrap position-relative"><img class="img-fluid rounded-4" src="assets/images/hero-page.jpg" alt="Scout Nova image placeholder" data-aos="fade-up" data-aos-delay="0">
                  <div class="mission-statement p-4 rounded-4 d-flex gap-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div>
                      ...
                      <p class="fs-5 mb-0">To empower young football and basketball players worldwide by using AI and innovative technology to make talent discovery transparent, fair, and accessible.</p>
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        <div class="col-lg-11">
                          <div class="h-100 flex-column justify-content-between d-flex">
                            <div>
                              ...
                              <p>Experience the future of scouting with our secure, efficient, and user-friendly services. Our cutting-edge platform ensures you are safe, streamlined, and easy to manage, empowering you to take control of your scouting journey with confidence and convenience.</p>
                        ...
                        <div class="col-lg-11">
                          <div class="row">
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="0">
                              <div class="icon text-center mb-4"><i class="bi bi-display fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3">User-Friendly Interface</h3>
                              <p>An intuitive and easy-to-navigate interface that allows players, coaches, and scouts to upload videos and view results effortlessly without technical knowledge.</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="100">
                              <div class="icon text-center mb-4"><i class="bi bi-cloud-upload fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3">Seamless Video Uploads</h3>
                              <p>Quickly upload football or basketball clips directly from your device; videos are automatically processed and analyzed by the AI system.</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="200">
                              <div class="icon text-center mb-4"><i class="bi bi-bar-chart-line fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3">Performance Dashboard</h3>
                              <p>View detailed analytics including passes, shots, assists, distance covered, and an overall performance score in one clean dashboard.</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="300">
                              <div class="icon text-center mb-4"><i class="bi bi-shield-lock fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3">Secure User Accounts</h3>
                              <p>Each user has a protected account with secure login, ensuring private access to personal videos and analysis results.</p>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="300">
                <div class="p-5 rounded-4 price-table h-100">
                  <h3>Free</h3>
                  <p>Profile creation and basic video uploads, Limited swipe access, Basic POD rating.</p>
                  <div class="price mb-4"><strong>$0</strong><span>/ month</span></div>
                  <div><a class="btn" href="register">Get Started</a></div>
                </div>
              </div>
              ...
              <div class="col-md-4 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="400">
                <div class="p-5 rounded-4 price-table h-100">
                  <h3>Scout Premium</h3>
                  <p>Unlimited watchlists, swipe, and advanced features, Swipe back and forth, Advanced POD filters, Priority access to new talents.</p>
                  <div class="price mb-4"><strong>$50</strong><span>/ month</span></div>
                  <div><a class="btn" href="register">Get Started</a></div>
                </div>
              </div>
              ...
              <div class="col-md-4 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="500">
                <div class="p-5 rounded-4 price-table h-100">
                  <h3>Player Premium</h3>
                  <p>Boost profile visibility, contact scouts/agents, Ability to contact scouts/agents for trials, Boosted profile visibility, Exclusive educational content.</p>
                  <div class="price mb-4"><strong>$100</strong><span>/ month</span></div>
                  <div><a class="btn" href="register">Get Started</a></div>
                </div>
              </div>
          ...
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-6 text-center mx-auto"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">How it works</span>
                <h2 data-aos="fade-up" data-aos-delay="100">For Players</h2>
                <p data-aos="fade-up" data-aos-delay="200">Our platform is designed to make managing your skilss simple and efficient. Follow these easy steps to get started: </p>
              </div>
            </div>
            <div class="row g-md-1">
              <div class="col-md-6 col-lg-3">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative" data-aos="fade-up" data-aos-delay="0">
                  <div data-aos="fade-right" data-aos-delay="500"><img class="arch-line" src="assets/images/arch-line.svg" alt="Scout Nova image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">1</span>
                  <div>
              ...
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
                <div class="step-card reverse text-center h-100 d-flex flex-column justify-content-start position-relative">
                  <div data-aos="fade-right" data-aos-delay="1100"><img class="arch-line reverse" src="assets/images/arch-line-reverse.svg" alt="Scout Nova image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">2</span>
                  <h3 class="fs-5 mb-4">Upload Skill Videos</h3>
                  <p>Showcase your skills through videos with our guided tutorials.</p>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1200">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative">
                  <div data-aos="fade-right" data-aos-delay="1700"><img class="arch-line" src="assets/images/arch-line.svg" alt="Scout Nova image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">3</span>
                  <h3 class="fs-5 mb-4">AI-Powered POD Ratings</h3>
                  <p>Receive growth tracking and AI-powered Player Overtime Development (POD) ratings.</p>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1800">
                <div class="step-card last text-center h-100 d-flex flex-column justify-content-start position-relative"><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">4</span>
                  <div>
                    <h3 class="fs-5 mb-4">Scout Notifications</h3>
                    <p>Get notified when scouts show interest and connect directly.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!-- ======= How it works =======-->
        <section class="section howitworks__v1" id="how-it-works2">
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-6 text-center mx-auto">
                <!-- <span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">How it works</span> -->
                <h2 data-aos="fade-up" data-aos-delay="100">For Scouts & Agents</h2>
                <p data-aos="fade-up" data-aos-delay="200">Our platform is designed to make managing your players simple and efficient. Follow these easy steps to get started: </p>
              </div>
            </div>
            <div class="row g-md-5">
              <div class="col-md-6 col-lg-3">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative" data-aos="fade-up" data-aos-delay="0">
                  ...
                  <div>
                    <h3 class="fs-5 mb-4">Sign Up</h3>
                    <p>Build your scout or agent profile specifying your sport and region.</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
                <div class="step-card reverse text-center h-100 d-flex flex-column justify-content-start position-relative">
                  <div data-aos="fade-right" data-aos-delay="1100"><img class="arch-line reverse" src="assets/images/arch-line-reverse.svg" alt="Scout Nova image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">2</span>
                  <h3 class="fs-5 mb-4">Discover Players</h3>
                  <p>Use a swipe interface to filter players by position, age, and POD rating.</p>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1200">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative">
                  <div data-aos="fade-right" data-aos-delay="1700"><img class="arch-line" src="assets/images/arch-line.svg" alt="Scout Nova image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">3</span>
                  <h3 class="fs-5 mb-4">Create Watchlists</h3>
                  <p>Track player development over time by adding them to your watchlist.</p>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1800">
                <div class="step-card last text-center h-100 d-flex flex-column justify-content-start position-relative"><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">4</span>
                  <div>
                    <h3 class="fs-5 mb-4">Communicate & Negotiate</h3>
                    <p>Negotiate contracts and communicate directly with players via our platform.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div>
                    ...
                    <h3 class="fs-5 mb-3">AI Video Analysis</h3>
                    <p class="mb-4">ScoutNova uses advanced AI and computer vision to analyze uploaded football and basketball videos, identifying key actions, performance metrics, and player efficiency automatically.</p>
                  </div>
                  <a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="register">
                    <span class="icons">
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div>
                    ...
                    <h3 class="fs-5 mb-3">Talent Video Upload & Management</h3>
                    <p class="mb-4">Players can easily upload short clips of their matches or training sessions. Videos are securely stored, analyzed, and made accessible to scouts and agents worldwide.</p>
                  </div>
                  <a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="register">
                    <span class="icons">
                      <i class="icon-1 bi bi-arrow-right-short"></i>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div>
                    ...
                    <h3 class="fs-5 mb-3">Player Performance Scoring</h3>
                    <p class="mb-4">Every analyzed video generates an objective performance score based on metrics like passes, shots, assists, and overall activity — giving scouts reliable data at a glance.</p>
                  </div>
                  <a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="register">
                    <span class="icons">
                      <i class="icon-1 bi bi-arrow-right-short"></i>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div>
                    ...
                    <h3 class="fs-5 mb-3">Player Overtime Development (POD) Tracking</h3>
                    <p class="mb-4">ScoutNova tracks each player's growth and performance over time, helping athletes monitor their progress and enabling scouts to spot consistent development patterns.</p>
                  </div>
                  <a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="register">
                    <span class="icons">
                      <i class="icon-1 bi bi-arrow-right-short"></i>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div>
                    ...
                    <h3 class="fs-5 mb-3">Global Scout-Talent Networking</h3>
                    <p class="mb-4">Connecting emerging talents with professional scouts, coaches, and agents globally — ScoutNova bridges the gap between local players and international opportunities.</p>
                  </div>
                  <a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="register">
                    <span class="icons">
                      <i class="icon-1 bi bi-arrow-right-short"></i>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div>
                    ...
                    <h3 class="fs-5 mb-3">Interactive Discovery & Matching</h3>
                    <p class="mb-4">Through a swipe-based discovery interface, scouts can quickly browse, shortlist, and connect with players who match their criteria — making digital scouting fast and engaging.</p>
                  </div>
                  <a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="register">
                    <span class="icons">
                      <i class="icon-1 bi bi-arrow-right-short"></i>
            ...
            <div class="row g-4" data-masonry="{&quot;percentPosition&quot;: true }">
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                    &ldquo;
                    ScoutNova changed my life. I uploaded a few clips from my local matches, and within weeks, I got contacted by a scout from Europe. The AI report made my profile stand out instantly.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img">
                      <img class="rounded-circle img-fluid" src="assets/images/person-sq-2-min.jpg" alt="Scout Nova image placeholder">
                    </div>
                    <div class="lh-base">
                      <strong class="d-block">Emeka Johnson</strong>
                      <span>Footballer, Lagos, Nigeria</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                    &ldquo;
                    The performance breakdown helped me understand my strengths and weaknesses. I use my ScoutNova analytics every week to improve my training sessions.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img">
                      <img class="rounded-circle img-fluid" src="assets/images/person-sq-1-min.jpg" alt="Scout Nova image placeholder">
                    </div>
                    <div class="lh-base">
                      <strong class="d-block">Carlos Mendes</strong>
                      <span>Basketball Player, São Paulo, Brazil</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                    &ldquo;
                    It's the first platform that gave me visibility as a female athlete from Africa. The fairness and transparency of the system make me feel seen and valued.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img">
                      <img class="rounded-circle img-fluid" src="assets/images/person-sq-5-min.jpg" alt="Scout Nova image placeholder">
                    </div>
                    <div class="lh-base">
                      <strong class="d-block">Aisha Bello</strong>
                      <span>Female Footballer, Accra, Ghana</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                    &ldquo;
                    ScoutNova saves me hours of screening. The AI-generated stats and scoring system make it easy to identify players who actually fit my team's needs.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img">
                      <img class="rounded-circle img-fluid" src="assets/images/person-sq-3-min.jpg" alt="Scout Nova image placeholder">
                    </div>
                    <div class="lh-base">
                      <strong class="d-block">David Okafor</strong>
                      <span>Football Scout, London, UK</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                    &ldquo;
                    This platform bridges continents. I've signed two African players discovered directly through ScoutNova — data-driven scouting is the future.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img">
                      <img class="rounded-circle img-fluid" src="assets/images/person-sq-7-min.jpg" alt="Scout Nova image placeholder">
                    </div>
                    <div class="lh-base">
                      <strong class="d-block">Maria Alvarez</strong>
                      <span>Sports Agent, Madrid, Spain</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                    &ldquo;
                    The Player Overtime Development (POD) tracker helps me monitor every player's growth across seasons. It's like having a full analytics team on my laptop.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img">
                      <img class="rounded-circle img-fluid" src="assets/images/person-sq-8-min.jpg" alt="Scout Nova image placeholder">
                    </div>
                    <div class="lh-base">
                      <strong class="d-block">Coach Raymond Lutaaya</strong>
                      <span>Academy Director, Kampala, Uganda</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="accordion custom-accordion" id="accordionPanelsStayOpenExample">
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne"> What is ScoutNova? </button>
                      </h2>
                      <div class="accordion-collapse collapse show" id="panelsStayOpen-collapseOne">
                        <div class="accordion-body">ScoutNova is an AI-powered digital scouting platform that connects emerging football and basketball players with scouts, coaches, and agents worldwide. It uses video uploads and performance analytics to showcase talent objectively.</div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo"> How does ScoutNova analyze player performance? </button>
                      </h2>
                      <div class="accordion-collapse collapse" id="panelsStayOpen-collapseTwo">
                        <div class="accordion-body">Our AI model reviews uploaded match or training videos, detects key movements and actions, and generates detailed performance reports — including metrics like speed, passes, accuracy, and overall efficiency.</div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree"> Who can use ScoutNova? </button>
                      </h2>
                      <div class="accordion-collapse collapse" id="panelsStayOpen-collapseThree">
                        <div class="accordion-body">ScoutNova is designed for players, scouts, coaches, and sports agents. Whether you’re an athlete seeking visibility or a scout looking for talent, the platform provides tools for both sides to connect effectively.</div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFour" aria-expanded="false" aria-controls="panelsStayOpen-collapseFour"> Is ScoutNova available outside Africa? </button>
                      </h2>
                      <div class="accordion-collapse collapse" id="panelsStayOpen-collapseFour">
                        <div class="accordion-body">Yes. While ScoutNova started in Africa, our platform supports users globally — including players and scouts from South America, Europe, and Asia. Our goal is to make global scouting more inclusive and accessible.</div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFive" aria-expanded="false" aria-controls="panelsStayOpen-collapseFive"> Do I need to pay to use ScoutNova? </button>
                      </h2>
                      <div class="accordion-collapse collapse" id="panelsStayOpen-collapseFive">
                        <div class="accordion-body">Basic registration is free. However, advanced analytics and premium exposure plans may require a subscription. Pricing details will be available inside your user dashboard after signup.</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="d-flex gap-5 flex-column">
                  <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="0">
                    <div class="icon d-block"><i class="bi bi-telephone"></i></div><span> <span class="d-block">Phone</span><strong>+234 800 000 0000</strong></span>
                  </div>
                  <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="100">
                    <div class="icon d-block"><i class="bi bi-send"></i></div><span> <span class="d-block">Email</span><strong>support@scoutnova.org</strong></span>
                  </div>
                  <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="icon d-block"><i class="bi bi-geo-alt"></i></div><span> <span class="d-block">Address</span>
                      <address class="fw-bold">28 Burundi Street <br> Wuse, Abuja, Nigeria</address></span>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
          ...
          <div class="container">
            ...
            <div class="row justify-content-between mb-5 g-xl-5">
              <div class="col-md-4 mb-5 mb-lg-0">
                ...
                <p class="mb-4">ScoutNova is a cutting-edge digital scouting platform connecting emerging football and basketball talents from Africa, South America, and beyond with professional scouts and agents across the globe.</p>
              </div>
              <div class="col-md-7">
                <div class="row g-2">
                  ...
                  <div class="col-md-6 col-lg-4 mb-4 mb-lg-0 quick-contact">
                    ...
                    <a class="d-flex mb-3" href="mailto:support@scoutnova.org">
                      <i class="bi bi-envelope-fill me-3"></i>
                      <span>support@scoutnova.org</span>
                    </a>
                    <a class="d-flex mb-3" href="tel://+2348000000000">
            ...
            <div class="row credits pt-3">
              <div class="col-xl-8 text-center text-xl-start mb-3 mb-xl-0">
                &copy;
                <script>document.write(new Date().getFullYear());</script> Scout Nova. 
                 All rights reserved. Designed with <i class="bi bi-heart-fill text-danger"></i> by <a href="https://harkone.com.ng">Harkone Designs</a>
              </div>
            </div>
          </div>
        </footer>
