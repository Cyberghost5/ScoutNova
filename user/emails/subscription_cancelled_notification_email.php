                ...
                <td>
                    ...
                    <tr>
                        <td style='padding:0 35px;'>
                            ...
                            <p>Your player profile has been successfully set up. You're now part of a growing network of talented football and basketball players who are taking their game to the next level.<br>
                            </p>
                            <p>
                            ...
                            <ul>
                                <li>🎥 <strong>Upload your highlight videos</strong> - show your skills and get rated by our team.</li>
                                <li>📊 <strong>Track your Player Development (POD)</strong> - see how your performance improves over time.</li>
                                <li>🌍 <strong>Get noticed</strong> - scouts and coaches use ScoutNova to discover emerging talent.</li>
                            </ul>
