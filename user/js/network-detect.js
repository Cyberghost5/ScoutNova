...
NetworkDetect.prototype = {
  getNetworks: function getNetworks() {
    return {
      ...
      mtn: ["0806", "0803", "0816", "0813", "0810", "0814", "0903", "0906", "0916", "0703", "0706", "0913"],
  ...
  validate: function validate() {
    ...
    if (!this.phone) {
      ...
      // return "Invalid entry, enter a telephone number";
    ...
    if (this.phone.length > 11 && this.phone.slice(0, 4) !== "+234") {
      ...
      // return "Number without +234 must not be greater than 11 digits";
      return "notbegreaterthan11";
    ...
    if (this.phone.length < 14 && this.phone.slice(0, 4) === "+234") {
      ...
      // return "Number with +234 must be 14 characters long";
      return "mustbe14"
    ...
    if (this.phone.length > 14 && this.phone.slice(0, 4) === "+234") {
      ...
      // return "Number with +234 must not be greater than 14 characters";
      return "mustnotbegreaterthan14"
    }
