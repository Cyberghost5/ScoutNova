        ...
        if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
          ...
          if (move_uploaded_file($fileTmpPath, $destPath)) {
              ...
              try {
                ...
                // Content
                $mail->isHTML(true);
                $mail->Subject = 'Welcome to '.$settings['site_name'].'! Your Player Profile is Live';
        ...
        if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
          ...
          if (move_uploaded_file($fileTmpPath, $destPath)) {
              ...
              try {
                ...
                // Content
                $mail->isHTML(true);
                $mail->Subject = 'Welcome to '.$settings['site_name'].' — Start Discovering Top Talent';
                
                ob_start();
                include 'emails/set_scout_profile_notification_email.php';
                $mail->Body = ob_get_clean();
